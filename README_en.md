...
> 📊 &nbsp;**v0.1** — meta-skill + tooling engine (**35 tests green**, stdlib-only) + **6 end-to-end
> samples** (rust / linear-algebra / english-reading / weight-loss / skincare / fitness, **79 modules**). Every sample's prereq graph is
...
**Hard numbers in this repo:** 79 modules across 6 samples, all engine-validated; 35 tests over the tooling.
...
| **Fitness** | physical · behavioral (honest degradation · ⚠️ not medical advice) | 13 | competent | [fitness-learn/](prototypes/fitness-learn/) |
...
├── prototypes/    # 6 end-to-end samples: rust / linear-algebra / english-reading / weight-loss / skincare / fitness (79 modules)
└── tests/         # 35 tests
```
...
|---------|---------|--------|
| v0.1 | meta-skill + tooling engine + **6 samples** + packaging | ✅ |
