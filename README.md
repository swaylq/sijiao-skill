...
| **健身（力量/增肌）** | 生理 · 行为（诚实降级 · ⚠️ 非医疗建议） | 13 | 胜任 | [fitness-learn/](prototypes/fitness-learn/) |

> 甜区起步（认知/知识型先跑通）；**减肥 / 皮肤管理 / 健身是非认知技能**（生理/行为），展示框架碰到这类技能怎么「诚实降级」——AI 教不了的（实际执行 / 身体状况 / 医学情况）标注转自报 / 线下 / 医生。<br>
